...
const features = [
  {
    ...
    description: "Automatically discover domains, subdomains, IPs, and exposed services across your entire infrastructure.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Vulnerability Assessment",
    description: "Detect vulnerabilities across web applications, networks, and cloud environments with precision and speed.",
    visual: "ai",
  },
  {
    number: "03",
    title: "CVE Intelligence",
    description: "Correlate discovered technologies with known vulnerabilities and exploit intelligence for complete visibility.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Cloud Security Assessment",
    description: "Assess AWS, Azure, and GCP environments for security risks, misconfigurations, and compliance gaps.",
    visual: "security",
  },
  {
    number: "05",
    title: "AI Security Analysis",
    description: "Generate risk summaries, remediation guidance, and attack-path insights powered by advanced AI models.",
    visual: "ai",
  },
  {
    number: "06",
    title: "Automated Reporting",
    description: "Produce executive and technical reports instantly with actionable recommendations and clear risk prioritization.",
    visual: "deploy",
  },
];
