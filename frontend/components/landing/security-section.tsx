...
const securityFeatures = [
  {
    ...
    description: "Comprehensive analysis of AWS, Azure, and GCP environments for vulnerabilities.",
  },
  {
    icon: Lock,
    title: "IAM & Access Analysis",
    description: "Detect overprivileged accounts, misconfigurations, and access risks.",
  },
  {
    icon: Eye,
    title: "Continuous Monitoring",
    description: "Real-time threat detection and automated security posture tracking.",
  },
  {
    icon: FileCheck,
    title: "Compliance Ready",
    description: "Generate compliance reports for PCI, HIPAA, SOC 2, and other frameworks.",
  },
];

const certifications = ["AWS", "Azure", "GCP", "SOC 2", "ISO 27001"];
